...
REM # clean
rm -r build_ninja_ndk_on_windows
mkdir build_ninja_ndk_on_windows

pushd build_ninja_ndk_on_windows
REM # generate makefile
REM # option 1, predefine.cmake must be include before PROJECT() section
cmake -G "Ninja" ../src 
REM # option 2
REM cmake -G "Ninja" ../src -DANDROID_NDK="%NDK_PATH%" -DCMAKE_TOOLCHAIN_FILE=%TOOL_CHAIN_FILE% -DANDROID_PLATFORM=android-24  -DCMAKE_BUILD_TYPE=Release  -DANDROID_ABI="arm64-v8a" -DCMAKE_MAKE_PROGRAM=%MAKE_PATH%
